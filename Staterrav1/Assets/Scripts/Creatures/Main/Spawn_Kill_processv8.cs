...
void Awake(){
	...
	void tierUpdates(){
		...
		for (int j =0; j<5; j++) {
			...
			while ((tiers[0,0] == false && tiers[0,1] == true) || (tiers[1,0] == false && tiers[1,1] == true)||
			       (tiers[2,0] == false && tiers[2,1] == true) || (tiers[3,0] == false && tiers[3,1] == true)||
			       (tiers[4,0] == false && tiers[4,1] == true)) {
				...
				if(Copepod_details.GetComponent<Animal_Section_Copepod>().pop!=0){
					...
					Copepod_details.GetComponent<Animal_parents> ().death [0] += Copepod_details.GetComponent<Animal_parents> ().pop;
					Copepod_details.GetComponent<Animal_parents> ().counter [0] += Copepod_details.GetComponent<Animal_parents> ().pop;
					Copepod_details.GetComponent<Animal_parents> ().pop += Copepod_details.GetComponent<Animal_parents> ().pop;
				}

				if(SeaUrchind_details.GetComponent<Animal_Section_Copepod>().pop!=0){
					for (int i =0; i<SeaUrchind_details.GetComponent<Animal_Section_Copepod>().pop; i++) {
					...
					SeaUrchind_details.GetComponent<Animal_parents> ().death [0] += SeaUrchind_details.GetComponent<Animal_parents> ().pop;
					SeaUrchind_details.GetComponent<Animal_parents> ().counter [0] += SeaUrchind_details.GetComponent<Animal_parents> ().pop;
					SeaUrchind_details.GetComponent<Animal_parents> ().pop += SeaUrchind_details.GetComponent<Animal_parents> ().pop;
				}
			}


			while ( (tiers[1,0] == false && tiers[1,1] == true)||(tiers[2,0] == false && tiers[2,1] == true) 
			       || (tiers[3,0] == false && tiers[3,1] == true)||(tiers[4,0] == false && tiers[4,1] == true)) {
				tiers [j, 0] = false; 
				tiers [j, 1] = false;
				...
				if(Crab_details.GetComponent<Animal_Section_Copepod>().pop!=0){
					for (int i =0; i<Crab_details.GetComponent<Animal_Section_Copepod>().pop; i++) {
						GameObject new_creat = Instantiate (Copepod, crab_spawn.transform.position, crab_spawn.transform.rotation) as GameObject;
...
//Seaurchin ================================================================================
				...
				if (creature.gameObject.name == "Shrimp_Counter") {
					...
					for (int i =0; i< creature.GetComponent<Animal_Section_Shrimp>().death[5]; i++) {
					...
					creature.GetComponent<Animal_parents> ().pop = creature.GetComponent<Animal_parents> ().pop  - 
						creature.GetComponent<Animal_Section_Shrimp>().death[5];
			...
			/*	death[0] =creature.GetComponent<Animal_Section_Shrimp>().death[0];
					...
					death[5] =creature.GetComponent<Animal_Section_Shrimp>().death[5];
					
					//counter modify
					for (int i =0; i<=2;i++){
						if(i==0 && creature.GetComponent<Animal_Section_Shrimp>().counter[0]>=death[5]){
							creature.GetComponent<Animal_Section_Shrimp>().counter[i] = creature.GetComponent<Animal_Section_Shrimp>().counter[i] - death[5];
							break;
						}else if (i!=0){
							
							creature.GetComponent<Animal_Section_Shrimp>().death[5] = creature.GetComponent<Animal_Section_Shrimp>().death[5]-
								creature.GetComponent<Animal_Section_Shrimp>().counter[i-1];
							if(creature.GetComponent<Animal_Section_Shrimp>().death[5] ==0){
								creature.GetComponent<Animal_Section_Shrimp>().counter[i-1] = creature.GetComponent<Animal_Section_Shrimp>().death[5];
							...
							}else if(creature.GetComponent<Animal_Section_Shrimp>().death[5] >0){
					...
					creature.GetComponent<Animal_Section_Shrimp>().shift_Values_death(5);
			...
			//jellyfish=============================================================================================
				...
				if (creature.gameObject.name == "Jellyfish_Counter") {
					...
					for (int i =0; i< creature.GetComponent<Animal_Section_Jellyfish>().death[7]; i++) {
					...
					creature.GetComponent<Animal_parents> ().pop = creature.GetComponent<Animal_parents> ().pop  - 
						creature.GetComponent<Animal_Section_Jellyfish>().death[7];

					
			
					death[9] =creature.GetComponent<Animal_Section_Jellyfish>().death[7];
					//counter modify
					for (int i =0; i<=3;i++){
						if(i==0 && creature.GetComponent<Animal_Section_Jellyfish>().counter[0]>=death[7]){
							...
							creature.GetComponent<Animal_Section_Jellyfish>().death[7] = creature.GetComponent<Animal_Section_Jellyfish>().death[6]-
								creature.GetComponent<Animal_Section_Jellyfish>().counter[i-1];
							if(creature.GetComponent<Animal_Section_Jellyfish>().death[7] ==0){
								creature.GetComponent<Animal_Section_Jellyfish>().counter[i-1] = creature.GetComponent<Animal_Section_Jellyfish>().death[7];
								
								break;

							}else if(creature.GetComponent<Animal_Section_Jellyfish>().death[7] >0){
					...
					//counter end
					creature.GetComponent<Animal_Section_Jellyfish>().shift_Values_death(7);
					...
					if (creature.gameObject.name == "Crab_Counter") {
						...
						for (int i =0; i< creature.GetComponent<Animal_Section_Crab>().death[5]; i++) {
						...
						creature.GetComponent<Animal_parents> ().pop = creature.GetComponent<Animal_parents> ().pop  - 
							creature.GetComponent<Animal_Section_Crab>().death[5];
	
						death[5] =creature.GetComponent<Animal_Section_Crab>().death[5];
						
						//counter modify
						for (int i =0; i<=2;i++){
							if(i==0 && creature.GetComponent<Animal_Section_Crab>().counter[0]>=death[5]){
								creature.GetComponent<Animal_Section_Crab>().counter[i] = creature.GetComponent<Animal_Section_Crab>().counter[i] - death[5];
								break;
							}else if (i!=0){
								
								creature.GetComponent<Animal_Section_Crab>().death[5] = creature.GetComponent<Animal_Section_Crab>().death[5]-
									creature.GetComponent<Animal_Section_Crab>().counter[i-1];
								if(creature.GetComponent<Animal_Section_Crab>().death[5] ==0){
									creature.GetComponent<Animal_Section_Crab>().counter[i-1] = creature.GetComponent<Animal_Section_Crab>().death[5];
									
									break;
			
								}else if(creature.GetComponent<Animal_Section_Crab>().death[5] >0){
						...
						creature.GetComponent<Animal_Section_Crab>().shift_Values_death(5);
					...
					if (creature.gameObject.name == "Bogue_Counter") {
						...
						for (int i =0; i< creature.GetComponent<Animal_Section_Bogue>().death[7]; i++) {
						...
						creature.GetComponent<Animal_parents> ().pop = creature.GetComponent<Animal_parents> ().pop  - 
							creature.GetComponent<Animal_Section_Bogue>().death[7];
						
						death[5] =creature.GetComponent<Animal_Section_Bogue>().death[7];
						
						//counter modify
						for (int i =0; i<=3;i++){
							if(i==0 && creature.GetComponent<Animal_Section_Crab>().counter[0]>=death[7]){
								creature.GetComponent<Animal_Section_Crab>().counter[i] = creature.GetComponent<Animal_Section_Crab>().counter[i] - death[7];
								break;
							}else if (i!=0){
								
								creature.GetComponent<Animal_Section_Crab>().death[7] = creature.GetComponent<Animal_Section_Crab>().death[7]-
									creature.GetComponent<Animal_Section_Crab>().counter[i-1];
								if(creature.GetComponent<Animal_Section_Crab>().death[5] ==0){
									creature.GetComponent<Animal_Section_Crab>().counter[i-1] = creature.GetComponent<Animal_Section_Crab>().death[7];
									
									break;
									
								}else if(creature.GetComponent<Animal_Section_Crab>().death[7] >0){
									creature.GetComponent<Animal_Section_Crab>().counter[i-1] =0;
						...
						creature.GetComponent<Animal_Section_Crab>().shift_Values_death(7);
				...
				if(creature.GetComponent<Animal_parents>().pop !=0){
					...
					if (creature.gameObject.name == "Bogue_Counter") {
						if (creature.GetComponent<Animal_parents> ().pop > 0) {
							...
							for (int i =0; i<creature.GetComponent<Animal_Section_Bogue>().counter[3]; i++) {
							...
							creature.GetComponent<Animal_parents> ().pop = creature.GetComponent<Animal_parents> ().pop +
								creature.GetComponent<Animal_Section_Crab> ().counter[3];
							...
							creature.GetComponent<Animal_Section_Bogue> ().counter[0] = prev_count[3] * 2;
							...
							creature.GetComponent<Animal_Section_Bogue> ().death[0] = prev_count[3] ;
						}
					...
					if (creature.gameObject.name == "Crab_Counter") {
						if (creature.GetComponent<Animal_parents> ().pop > 0) {
							...
							for (int i =0; i<creature.GetComponent<Animal_Section_Crab>().counter[2]; i++) {
							...
							creature.GetComponent<Animal_Section_Crab> ().counter[0] = prev_count[2] * 2;
							...
							creature.GetComponent<Animal_Section_Crab> ().death[0] = prev_count[2] ;
						}
