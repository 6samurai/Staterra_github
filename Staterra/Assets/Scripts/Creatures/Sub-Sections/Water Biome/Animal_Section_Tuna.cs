...
public class Animal_Section_Tuna : Animal_parents {

	
	//public int count_pop = 0;

	public Animal_Section_Tuna(){
	...
	public void Feeding_Cycle(ref Animal_Section_Seabass food1, ref Animal_Section_Squid food2){
