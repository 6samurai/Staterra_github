...
public class Animal_Section_Octopus : Animal_parents {
	

	public Animal_Section_Octopus(){
		base.max_pop = 50;
	base.power=44;
	base.defence=102;
...
public void Feeding_Cycle(ref Animal_Section_Crab food1, ref Animal_Section_Squid food2, ref Animal_Section_Jellyfish food3, ref Animal_Section_SeaUrchin food4, ref Animal_Section_Starfish food5, ref Animal_Section_Bogue food6, ref Animal_Section_Seabass food7){
	
	Animal_parents [] foods = new Animal_parents[7];
	int pops = pop;
	int lastindex = 0;
