...
public class Animal_Section_HammerheadShark : Animal_parents {
	

	public Animal_Section_HammerheadShark(){
...
public void Death_Cycle(int blank){
	...
	public void Feeding_Cycle(ref Animal_Section_GulperShark food1, ref Animal_Section_Tuna food2, ref Animal_Section_Turtle food3){
