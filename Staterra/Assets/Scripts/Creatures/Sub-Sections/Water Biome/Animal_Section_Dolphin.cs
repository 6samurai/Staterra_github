...
public class Animal_Section_Dolphin : Animal_parents {
	...
	public void Feeding_Cycle(ref Animal_Section_Tuna food1, ref Animal_Section_Seabass food2, ref Animal_Section_GulperShark food3){
