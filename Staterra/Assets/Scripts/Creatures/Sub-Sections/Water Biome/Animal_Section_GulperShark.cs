...
public class Animal_Section_GulperShark : Animal_parents {
	



	public Animal_Section_GulperShark(){
	...
	public void Feeding_Cycle(ref Animal_Section_Octopus food1, ref Animal_Section_Seabass food2, ref Animal_Section_Squid food3, ref Animal_Section_Tuna food4){
