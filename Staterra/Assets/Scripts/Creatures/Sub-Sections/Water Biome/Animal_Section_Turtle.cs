...
public class Animal_Section_Turtle : Animal_parents {
	


	public Animal_Section_Turtle(){
	...
	public void Feeding_Cycle(ref Animal_Section_Jellyfish food1, ref Animal_Section_Squid food2, ref Animal_Section_Octopus food3, ref Animal_Section_Starfish food4, ref Animal_Section_Bogue food5){
		
		Animal_parents [] foods = new Animal_parents[5];
		int pops = pop;
		int lastindex = 0;
